...
set(VCPKG_CXX_FLAGS "/Zc:__cplusplus /permissive /utf-8 -clang:-fno-delayed-template-parsing" CACHE STRING "")
...
set(VCPKG_CHAINLOAD_TOOLCHAIN_FILE "${CMAKE_CURRENT_LIST_DIR}/../toolchains/custom-toolchain-llvm.cmake")
# need to with VCPKG_CHAINLOAD_TOOLCHAIN_FILE on Windows
set(VCPKG_LOAD_VCVARS_ENV ON)
# need to be ENV{VCPKG_ROOT} used by custom toolchain on Windows
set(VCPKG_ENV_PASSTHROUGH_UNTRACKED "VCPKG_ROOT;llvmX64;CUDA_PATH;VCToolsInstallDir")
# ref: https://github.com/Neumann-A/my-vcpkg-triplets/blob/master/x64-win-llvm.cmake
